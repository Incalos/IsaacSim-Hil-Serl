"""SO101 pick-oranges environment package.

This module defines the USD assets/config objects (scene + robot articulation) and
registers a Gymnasium environment ID for `gym.make(...)`.
"""
...
# Robot assets and articulation configuration
...
gym.register(
    ...
    kwargs={
        "env_cfg_entry_point": f"{__name__}.pick_oranges_env_cfg:PickOrangesEnvCfg",
    },
)
