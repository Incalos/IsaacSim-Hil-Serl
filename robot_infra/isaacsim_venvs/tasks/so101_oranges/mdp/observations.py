...
def orange_grasped(
    ...
    # Calculate position difference between orange and end-effector
    ...
    # Check if orange is grasped (close to EE + gripper closed)
...
def put_orange_to_plate(
    ...
    # Check if orange is within plate's x-y range
    ...
    # Check if end-effector is near orange
    ee_pos_w = ee_frame.data.target_pos_w[:, 1, :]
    ...
    # Combine all conditions to check if orange is placed on plate
