...
# Map model_name to (model_class, weights_class)
_RESNET_REGISTRY = {
...
class _ResNetBackbone(nn.Module):
    """ResNet backbone that outputs [B, C, H, W] by skipping avgpool/fc."""
...
def _make_resnet_backbone(model_name: str, pretrained: bool) -> nn.Module:
    """Create ResNet backbone without classifier/global pool, output [B, C, H, W]."""
